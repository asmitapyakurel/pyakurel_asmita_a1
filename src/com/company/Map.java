...
public class Map extends JComponent{
    ...
    // Score and their labels
    int i = 0;

    JLabel score1;

    // The game timer and speed at which tick called
    int interval = 20;
    Timer time;
    boolean run = true;

    // Add KeyListeners and initialize field
...
//        }
    ...
    // Initializes new characters and restart the timer
    public void reset() {
    ...
    public void addPlayers(String playerString) {
        ...
        for (int i = 0; i < playersArray.length; i++) {
            if (!(playersArray[i].equals(NAME))) {
                ...
                jetwallStatus = true;
                OnlinePlayer player = new OnlinePlayer(x, y, 0, 0, colors[i], "", name, jetwallStatus);
