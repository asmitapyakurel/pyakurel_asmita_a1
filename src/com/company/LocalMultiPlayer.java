...
//            (300, 100, 0, 5, Color.YELLOW, "Player3", "DOWN", true);
    ...
    // Game timer and speed at which tick() called
    int interval = 20;
    Timer timer;
    boolean run = true;
    ...
    // Add KeyListener and initialize field
...
//        this.score3 = sco3;
    ...
    // Initializes new characters and Restarts timer
    public void reset() {
        p1 = false;
        p2 = false;
        p3 = false;
